...
class PlaylistCreator:
    ...
    def search_song_uri(self, artist: str, track: str) -> str:
        ...
        try:
            ...
            if artist == "Manual Query: ":
                results = self.sp.search(q=f"{track}", type="track", limit=10)
            else:
            ...
            while True:
                choice = input("Select a song (1-10), type 's' to skip, or 'try: query' to manually search your query: ")
                ...
                if choice.isdigit() and 1 <= int(choice) <= 10:
                    ...
                    return None
                elif choice.lower()[:4] == "try:":
                    print('Searching manual query')
                    return self.search_song_uri("Manual Query: ", choice.lower()[5:])
                else:
                    print("Invalid choice. Please select a number between 1 and 10, type 's' to skip, or type 's' to search just the track name")
    ...
    def get_liked_songs(self):
        offset = 0
        limit = 50  # Maximum allowed by the API per call
        all_liked_songs = []
        ...
        while True:
            ...
            for item in results["items"]:
                ...
                all_liked_songs.append(track_info)
